"""Per-broker order-intent extractors (SPEC.md Mandate Enforcement S4).
...
All connector-specific extractors removed during foreign-market cleanup.
"""
...
#: All connector extractors removed during foreign-market cleanup.
