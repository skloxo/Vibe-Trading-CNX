...
<h1 align="center">Vibe-Trading: Your A-Share & HK Quant Trading Agent</h1>

<p align="center">
  <b>Empower Your Agent with Multi-Agent Swarms, Backtesting, and Broker Connectors</b>
</p>
...
- **2026-06-24** 🚀 **v0.1.10-s1 — Chinese Localization Refinements & A-Share Quant Workstation Focus**: Refined Chinese (zh-CN) localization across all major pages (Welcome Screen prompts/examples, AlphaZoo categories, Correlation heatmaps, and Settings). Cleaned up foreign broker connectors to specialize in A-Share & HK markets. Established local credentials sandboxing and dual-subagent test validation SOP.
...
- **2026-06-13** 🌏 **Frontend i18n — Chinese (zh-CN) localization**: The Web UI now supports Chinese (zh-CN) with a complete i18next-based internationalization layer. All 20+ components and pages use `useTranslation()` hooks for reactive language switching, with 449 translation keys covering navigation, chat, settings, charts, and error messages. A single toggle button in the sidebar switches between Chinese and English on the fly. Translation files: `src/i18n/locales/zh-CN.json` and `en.json` ([#207](https://github.com/HKUDS/Vibe-Trading/pull/207), thanks @skloxo).
...
| **Trading Connectors UI** (s8) | Settings page visualization and configuration card for simulated trading, Futu, IBKR, and custom MCP connectors | In Progress / Next |
| **Typical Use-cases Showcase** (s9) | Web UI landing page overhaul with highlights of financial skills, swarm agents, and standard quant scenarios (A-share backtesting, investment debate, log triage) | In Progress / Next |
